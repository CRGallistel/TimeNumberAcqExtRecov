...
%% CRG code 10/23/2019 & later
for S=[1:6 13:18] % seeting Phase field
...
TSapplystat('AcqTrial','AcqPkNumDiff',@Acq,c)
TSlimit('Phases',2);
...
for plt=1:6
    subplot(3,2,plt)
    plot(cumsum(Experiment.Subject(plt).AcqPkNumDiff),'k-','LineWidth',2)
    hold on
...
for plt=1:6
    subplot(3,2,plt)
    plot(cumsum(Experiment.Subject(plt+6).AcqPkNumDiff),'k-','LineWidth',2)
    hold on
...
legend('7,40,7','28,10,28','7,40,28','location','NW')
title('')
%
subplot(4,2,2)
